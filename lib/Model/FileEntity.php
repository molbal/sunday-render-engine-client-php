...
class FileEntity implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("HTML", "SCRIPT", "STYLESHEET", "IMAGE", "OTHER");
    ...
    public function setType($type)
    {
        ...
        if (!in_array($type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'HTML', 'SCRIPT', 'STYLESHEET', 'IMAGE', 'OTHER'");
        }
