...
class ApiClient
{
     ...
     */
    public function __construct(\Sunday\RenderClient\Configuration $config = null)
    {
        if ($config == null) {
     ...
     *
     * @throws \Sunday\RenderClient\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers)) {
            ...
            $postData = json_encode(\Sunday\RenderClient\ObjectSerializer::sanitizeForSerialization($postData));
        }
