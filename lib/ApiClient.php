...
class ApiClient
{
     ...
     */
    public function __construct(\Sunday\RenderService\Client\Configuration $config = null)
    {
        if ($config == null) {
     ...
     *
     * @throws \Sunday\RenderService\Client\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers)) {
            ...
            $postData = json_encode(\Sunday\RenderService\Client\ObjectSerializer::sanitizeForSerialization($postData));
        }
